...
public class MainActivity extends AppCompatActivity {
    ...
    private MyModel[] cv_pages = {
            new MyModel("Ann Arbor", "Clear", android.R.color.holo_orange_light,"48105","16°C"),
            new MyModel("Yuma", "Cloud", android.R.color.holo_green_light,"85364", "16°C"),
            new MyModel("Orlando", "Rain", android.R.color.holo_blue_light,"32801", "16°C"),
            new MyModel("Ypsilanti","Rain", android.R.color.holo_blue_light,"48197", "16°C"),
            new MyModel("Fort Wainwright","Rain", android.R.color.holo_blue_light,"99703", "16°C"),
    };
